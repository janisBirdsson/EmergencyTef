...
function SylTefMap(){
  ...
  /*
  participantMap.set("JPl7", ParticipantType.JUDGE);
  participantMap.set("3BQn2", ParticipantType.JUDGE);
  participantMap.set("4Odjt", ParticipantType.JUDGE);
  participantMap.set("3Cbn6", ParticipantType.JUDGE);
  participantMap.set("4NQpv", ParticipantType.CHALLENGER);
  participantMap.set("Hcg3", ParticipantType.COMPETITOR);
  participantMap.set("4MZgw", ParticipantType.WILDCARD);
  participantMap.set("4GUk5", ParticipantType.CHALLENGER);
  participantMap.set("DSn7", ParticipantType.WILDCARD);
  participantMap.set("4Dcq0", ParticipantType.JUDGE);
  participantMap.set("JWsu", ParticipantType.COMPETITOR);
  participantMap.set("3Bbs4", ParticipantType.JUDGE);
  participantMap.set("3DPpt", ParticipantType.COMPETITOR);
  participantMap.set("1Icn2", ParticipantType.WILDCARD);
  participantMap.set("2BTp1", ParticipantType.CHALLENGER);
  participantMap.set("4NYsy", ParticipantType.CHALLENGER);
  participantMap.set("4OSs6", ParticipantType.COMPETITOR);
  participantMap.set("2GYpw", ParticipantType.JUDGE);
  participantMap.set("4HRi7", ParticipantType.WILDCARD);
  participantMap.set("2ASet", ParticipantType.CHALLENGER);
  participantMap.set("4HUky", ParticipantType.COMPETITOR);
  participantMap.set("EQgx", ParticipantType.WILDCARD);
  participantMap.set("Abj1", ParticipantType.WILDCARD);
  participantMap.set("3JRky", ParticipantType.JUDGE);
  participantMap.set("3DRk4", ParticipantType.CHALLENGER);
  participantMap.set("4Bcp4", ParticipantType.CHALLENGER);
  participantMap.set("3MZoz", ParticipantType.WILDCARD);
  participantMap.set("3ESnt", ParticipantType.CHALLENGER);
  participantMap.set("1Dbn6", ParticipantType.WILDCARD);
  participantMap.set("2FPey", ParticipantType.JUDGE);
  participantMap.set("2Fblt", ParticipantType.JUDGE);
  participantMap.set("4MYf7", ParticipantType.JUDGE);
  participantMap.set("2BPet", ParticipantType.JUDGE);
  participantMap.set("MYju", ParticipantType.JUDGE);
  participantMap.set("2Malx", ParticipantType.CHALLENGER);
  participantMap.set("LSjy", ParticipantType.JUDGE);
  participantMap.set("EZit", ParticipantType.WILDCARD);
  participantMap.set("ITqt", ParticipantType.WILDCARD);
  participantMap.set("4NYr0", ParticipantType.WILDCARD);
  participantMap.set("3Mbq0", ParticipantType.WILDCARD);
  participantMap.set("4Jclw", ParticipantType.CHALLENGER);
  participantMap.set("1HSfz", ParticipantType.JUDGE);
  participantMap.set("3HWsy", ParticipantType.COMPETITOR);
  participantMap.set("4DSsu", ParticipantType.WILDCARD);
  participantMap.set("4OQju", ParticipantType.JUDGE);
  participantMap.set("2Hds1", ParticipantType.COMPETITOR);
  participantMap.set("2BQlu", ParticipantType.CHALLENGER);
  participantMap.set("Dbe3", ParticipantType.JUDGE);
  participantMap.set("4MWg5", ParticipantType.WILDCARD);
  participantMap.set("4ASp7", ParticipantType.JUDGE);
  participantMap.set("1Bah5", ParticipantType.CHALLENGER);
  participantMap.set("3MPq4", ParticipantType.JUDGE);
  participantMap.set("3CPs6", ParticipantType.CHALLENGER);
  participantMap.set("CYq5", ParticipantType.JUDGE);
  participantMap.set("4MSg7", ParticipantType.COMPETITOR);
  participantMap.set("2BRj0", ParticipantType.CHALLENGER);
  participantMap.set("AVlw", ParticipantType.WILDCARD);
  participantMap.set("1Hbj0", ParticipantType.JUDGE);
  participantMap.set("2Dahu", ParticipantType.WILDCARD);
  participantMap.set("3GYgz", ParticipantType.JUDGE);
  participantMap.set("4FQfv", ParticipantType.JUDGE);
  participantMap.set("4FYn5", ParticipantType.WILDCARD);
  participantMap.set("2FZoz", ParticipantType.JUDGE);
  participantMap.set("4GYp6", ParticipantType.JUDGE);
  participantMap.set("EXr6", ParticipantType.WILDCARD);
  participantMap.set("3Cbj5", ParticipantType.WILDCARD);
  participantMap.set("Ibq7", ParticipantType.JUDGE);
  participantMap.set("4KYny", ParticipantType.CHALLENGER);
  participantMap.set("BYfx", ParticipantType.JUDGE);
  participantMap.set("4IRiy", ParticipantType.WILDCARD);
  participantMap.set("4Odsx", ParticipantType.COMPETITOR);
  participantMap.set("1BTet", ParticipantType.WILDCARD);
  participantMap.set("Jdq1", ParticipantType.JUDGE);
  participantMap.set("1DZr2", ParticipantType.JUDGE);
  participantMap.set("GYi1", ParticipantType.WILDCARD);
  participantMap.set("1BXo3", ParticipantType.WILDCARD);
  participantMap.set("2HRl2", ParticipantType.COMPETITOR);
  participantMap.set("4FWl0", ParticipantType.JUDGE);
  participantMap.set("1MZr1", ParticipantType.COMPETITOR);
  participantMap.set("2AQey", ParticipantType.CHALLENGER);
  participantMap.set("OSr2", ParticipantType.JUDGE);
  participantMap.set("KWru", ParticipantType.JUDGE);
  participantMap.set("3Hcr2", ParticipantType.JUDGE);
  participantMap.set("Ecf2", ParticipantType.JUDGE);
  participantMap.set("3HYr6", ParticipantType.COMPETITOR);
  participantMap.set("4MWf5", ParticipantType.JUDGE);
  // participantMap.set("2DZf6", ParticipantType.WILDCARD);
  participantMap.set("1NSm7", ParticipantType.WILDCARD);
  participantMap.set("4JUrz", ParticipantType.COMPETITOR);
  participantMap.set("3KZpt", ParticipantType.WILDCARD);
  participantMap.set("4Bcr6", ParticipantType.WILDCARD);
  participantMap.set("4Dagu", ParticipantType.CHALLENGER);
  participantMap.set("Odl5", ParticipantType.JUDGE);
  participantMap.set("1DSiw", ParticipantType.JUDGE);
  participantMap.set("4IZsx", ParticipantType.JUDGE);
  participantMap.set("2MXpu", ParticipantType.WILDCARD);
  participantMap.set("1Jae1", ParticipantType.JUDGE);
  participantMap.set("4Abgu", ParticipantType.JUDGE);
  participantMap.set("4NThy", ParticipantType.JUDGE);
  participantMap.set("1OYox", ParticipantType.JUDGE);
  participantMap.set("3GSqy", ParticipantType.JUDGE);
  participantMap.set("2MZrx", ParticipantType.JUDGE);
  participantMap.set("2Ldou", ParticipantType.WILDCARD);
  participantMap.set("4FZjz", ParticipantType.CHALLENGER);
  participantMap.set("1Nbhv", ParticipantType.WILDCARD);
  participantMap.set("Kdov", ParticipantType.JUDGE);
  participantMap.set("Lbj7", ParticipantType.JUDGE);
  participantMap.set("EUr3", ParticipantType.WILDCARD);
  participantMap.set("Gdqz", ParticipantType.COMPETITOR);
  participantMap.set("4OQnu", ParticipantType.WILDCARD);
  participantMap.set("4Ncp7", ParticipantType.CHALLENGER);
  participantMap.set("3JWry", ParticipantType.JUDGE);
  participantMap.set("3Mbe1", ParticipantType.JUDGE);
  participantMap.set("2EXm1", ParticipantType.WILDCARD);
  participantMap.set("3MYs1", ParticipantType.JUDGE);
  participantMap.set("4Kcnt", ParticipantType.WILDCARD);
  participantMap.set("4Ddiz", ParticipantType.WILDCARD);
  participantMap.set("4JWgx", ParticipantType.WILDCARD);
  participantMap.set("3OVf0", ParticipantType.WILDCARD);
  participantMap.set("EWju", ParticipantType.CHALLENGER);
  participantMap.set("FRgv", ParticipantType.CHALLENGER);
  participantMap.set("1Lci4", ParticipantType.WILDCARD);
  participantMap.set("3Nae2", ParticipantType.WILDCARD);
  participantMap.set("4MYnw", ParticipantType.WILDCARD);
  participantMap.set("Hcr7", ParticipantType.JUDGE);
  participantMap.set("4NPsz", ParticipantType.WILDCARD);
  participantMap.set("KXl2", ParticipantType.JUDGE);
  participantMap.set("4Dbnx", ParticipantType.COMPETITOR);
  participantMap.set("Dah2", ParticipantType.COMPETITOR);
  participantMap.set("4Gch2", ParticipantType.WILDCARD);
  participantMap.set("2MSe3", ParticipantType.WILDCARD);
  participantMap.set("2LZj3", ParticipantType.WILDCARD);
  participantMap.set("CTo1", ParticipantType.COMPETITOR);
  participantMap.set("4DYp7", ParticipantType.JUDGE);
  participantMap.set("APqv", ParticipantType.CHALLENGER);
  participantMap.set("4Dcqz", ParticipantType.WILDCARD);
  participantMap.set("1AZm0", ParticipantType.CHALLENGER);
  participantMap.set("GTf1", ParticipantType.JUDGE);
  participantMap.set("3Iai4", ParticipantType.COMPETITOR);
  participantMap.set("4OQs4", ParticipantType.JUDGE);
  participantMap.set("4MSp6", ParticipantType.WILDCARD);
  participantMap.set("3LSh1", ParticipantType.JUDGE);
  participantMap.set("4MTn6", ParticipantType.JUDGE);
  participantMap.set("4FQkv", ParticipantType.WILDCARD);
  participantMap.set("4FQgt", ParticipantType.WILDCARD);
  participantMap.set("3MYe5", ParticipantType.WILDCARD);
  participantMap.set("DVe6", ParticipantType.COMPETITOR);
  participantMap.set("1OQf5", ParticipantType.WILDCARD);
  participantMap.set("1Jbq0", ParticipantType.COMPETITOR);
  participantMap.set("CXk6", ParticipantType.COMPETITOR);
  participantMap.set("4JYi6", ParticipantType.WILDCARD);
  participantMap.set("3BTst", ParticipantType.CHALLENGER);
  participantMap.set("4MUk7", ParticipantType.CHALLENGER);
  participantMap.set("3BRp1", ParticipantType.CHALLENGER);
  participantMap.set("3Dcs5", ParticipantType.CHALLENGER);
  participantMap.set("4MPst", ParticipantType.COMPETITOR);
  participantMap.set("4MUm6", ParticipantType.JUDGE);
  participantMap.set("KRhu", ParticipantType.WILDCARD);
  participantMap.set("2AWpx", ParticipantType.WILDCARD);
  participantMap.set("3JXmz", ParticipantType.WILDCARD);
  participantMap.set("3DQq7", ParticipantType.JUDGE);
  participantMap.set("1OZf3", ParticipantType.CHALLENGER);
  participantMap.set("3HWsu", ParticipantType.WILDCARD);
  participantMap.set("2OPft", ParticipantType.WILDCARD);
  participantMap.set("ITq2", ParticipantType.COMPETITOR);
  participantMap.set("4BPl4", ParticipantType.WILDCARD);
  participantMap.set("JXk0", ParticipantType.JUDGE);
  participantMap.set("2AUp1", ParticipantType.CHALLENGER);
  participantMap.set("1OWpt", ParticipantType.WILDCARD);
  participantMap.set("Ocs4", ParticipantType.JUDGE);
  participantMap.set("Ndhy", ParticipantType.JUDGE);
  participantMap.set("4Laqw", ParticipantType.JUDGE);
  
  participantMap.set("4NXmu", ParticipantType.COMPETITOR);
  participantMap.set("4ASj4", ParticipantType.JUDGE);
  participantMap.set("1Nbs3", ParticipantType.WILDCARD);
  participantMap.set("2ERoz", ParticipantType.CHALLENGER);
  participantMap.set("3CQs1", ParticipantType.WILDCARD);
  participantMap.set("4HXjv", ParticipantType.WILDCARD);
  participantMap.set("1KWiu", ParticipantType.WILDCARD);
  participantMap.set("2Cbf0", ParticipantType.JUDGE);
  participantMap.set("2HXm7", ParticipantType.JUDGE);
  participantMap.set("4FUm6", ParticipantType.JUDGE);
  participantMap.set("IYgt", ParticipantType.JUDGE);
  participantMap.set("1MXnx", ParticipantType.WILDCARD);
  participantMap.set("2IZe5", ParticipantType.JUDGE);
  participantMap.set("1LXe1", ParticipantType.WILDCARD);
  participantMap.set("4KTi7", ParticipantType.JUDGE);
  participantMap.set("1Ddsv", ParticipantType.COMPETITOR);
  participantMap.set("4MVf6", ParticipantType.JUDGE);
  participantMap.set("4Hbs5", ParticipantType.JUDGE);
  participantMap.set("3NYq5", ParticipantType.JUDGE);
  participantMap.set("2Abe3", ParticipantType.JUDGE);
  participantMap.set("2OSqu", ParticipantType.CHALLENGER);
  participantMap.set("3Bdq7", ParticipantType.JUDGE);
  participantMap.set("4NZq7", ParticipantType.COMPETITOR);
  participantMap.set("3CTet", ParticipantType.JUDGE);
  participantMap.set("2AYjz", ParticipantType.WILDCARD);
  participantMap.set("2JYiz", ParticipantType.WILDCARD);
  participantMap.set("4CVr4", ParticipantType.JUDGE);
  participantMap.set("AWp4", ParticipantType.WILDCARD);
  participantMap.set("4OVh0", ParticipantType.JUDGE);
  participantMap.set("HVq1", ParticipantType.JUDGE);
  
  participantMap.set("3EPkz", ParticipantType.CHALLENGER);
  participantMap.set("4EXq0", ParticipantType.JUDGE);
  participantMap.set("2Aaht", ParticipantType.COMPETITOR);
  
  // participantMap.set("4OXny", ParticipantType.WILDCARD);
  participantMap.set("JVo0", ParticipantType.WILDCARD);
  participantMap.set("3LVr3", ParticipantType.JUDGE);
  participantMap.set("2Ncex", ParticipantType.WILDCARD);
  participantMap.set("4MSn5", ParticipantType.CHALLENGER);
  participantMap.set("FTfw", ParticipantType.JUDGE);
  participantMap.set("4HTh0", ParticipantType.JUDGE);
  participantMap.set("3Dci5", ParticipantType.CHALLENGER);
  participantMap.set("Bclz", ParticipantType.CHALLENGER);
  participantMap.set("FThv", ParticipantType.JUDGE);
  participantMap.set("2MRg1", ParticipantType.WILDCARD);
  participantMap.set("4IRe2", ParticipantType.WILDCARD);
  participantMap.set("4Kbq3", ParticipantType.COMPETITOR);
  participantMap.set("3MYgu", ParticipantType.JUDGE);
  participantMap.set("4JSf7", ParticipantType.JUDGE);
  participantMap.set("4EZe1", ParticipantType.WILDCARD);
  participantMap.set("4NXnw", ParticipantType.WILDCARD);
  participantMap.set("4NXnw", ParticipantType.WILDCARD);
  participantMap.set("2APrz", ParticipantType.JUDGE);
  
  participantMap.set("1Fao0", ParticipantType.WILDCARD);
  participantMap.set("FPk6", ParticipantType.JUDGE);
  participantMap.set("4NUj6", ParticipantType.WILDCARD);
  participantMap.set("2CXhu", ParticipantType.COMPETITOR);
  participantMap.set("1HZl1", ParticipantType.WILDCARD);
  participantMap.set("2LQou", ParticipantType.JUDGE);
  participantMap.set("4JQl7", ParticipantType.JUDGE);
  participantMap.set("3LPi5", ParticipantType.JUDGE);
  participantMap.set("4MXl3", ParticipantType.CHALLENGER);
  participantMap.set("2JWkt", ParticipantType.JUDGE);
  participantMap.set("1JSl4", ParticipantType.CHALLENGER);
  participantMap.set("1Dbj2", ParticipantType.CHALLENGER);
  participantMap.set("1Jary", ParticipantType.WILDCARD);
  
  participantMap.set("3JPpz", ParticipantType.WILDCARD);
  participantMap.set("1HXi7", ParticipantType.COMPETITOR);
  participantMap.set("1Dcn0", ParticipantType.WILDCARD);
  participantMap.set("3EUsu", ParticipantType.JUDGE);
  participantMap.set("Dal0", ParticipantType.COMPETITOR);
  participantMap.set("3Dbl6", ParticipantType.WILDCARD);
  participantMap.set("3HWfz", ParticipantType.CHALLENGER);
  participantMap.set("4NSnw", ParticipantType.WILDCARD);
  participantMap.set("4Icg6", ParticipantType.WILDCARD);
  participantMap.set("3Dcez", ParticipantType.WILDCARD);
  participantMap.set("Kbq4", ParticipantType.CHALLENGER);
  
  participantMap.set("4OQh5", ParticipantType.WILDCARD);
  participantMap.set("3NRk5", ParticipantType.CHALLENGER);
  participantMap.set("2FWqw", ParticipantType.COMPETITOR);
  participantMap.set("1JWex", ParticipantType.WILDCARD);
  
  participantMap.set("JPi0", ParticipantType.WILDCARD);
  */
  ...
  */
  ...
  function addPlayerElems(entity){
    ...
    entityData.userPageUrl = playerPageUrl + entityData.pictoWord;
